...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2022 a las 17:37:57
...
(1, 'Marconi', '1990', '7', 'A', '7600'),
(2, 'Colon', '4190', '8', 'G', '7600');
...
(1, 1, 2, 2, 20000, 'qr.png', '2022-11-28', 1),
(2, 1, 2, 4, 10000, 'qr.png', '2022-11-28', 0);
...
(1, 'pexels-alexas-fotos-2173872.jpg', 1),
(2, 'pexels-dorte-179221.jpg', 2);
...
(1, 1, 2, 1, '2022-12-01', '2022-12-10', 25000, 'rejected'),
(2, 1, 2, 1, '2022-12-01', '2022-12-08', 20000, 'completed & reviewed'),
(3, 1, 2, 2, '2022-12-15', '2022-12-20', 15000, 'await'),
(4, 1, 2, 1, '2022-12-15', '2022-12-18', 10000, 'confirmed');
...
(1, 1, 2, 2, 5, 'Todo de 10, muy atentos y amables!');
...
(1, 'dueno1@gmail.com', '123456', 'D', '32876543', '20328765432', 'Cristian', 'Reboredo', '2234775678', 1),
(2, 'guardian1@gmail.com', '123456', 'G', '38005815', '23380058156', 'Romina', 'Schutz', '2234895645', 1);
...
(1, 'pexels-yuri-manei-3211476.jpg', 1),
(2, 'pexels-da-capture-14036568.jpg', 2);
...
(1, 'carnetVacunacion.jpg', 1),
(2, 'carnetVacunacion2.jpg', 2);
...
--
ALTER TABLE `availabledates`
  MODIFY `availabledatesid` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
...
--
ALTER TABLE `users`
  MODIFY `userid` int(11) NOT NULL AUTO_INCREMENT COMMENT 'user id', AUTO_INCREMENT=3;
